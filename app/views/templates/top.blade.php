...
.WB_right_expand .expand{
	...
	border-radius: 2px;
	-moz-box-shadow: 0 0 1px 1px rgba(0,0,0,0.1),0 1px 2px 0 rgba(0,0,0,0.2);
	-webkit-box-shadow: 0 0 1px 1px rgba(0,0,0,0.1),0 1px 2px 0 rgba(0,0,0,0.2);
	box-shadow: 0 0 1px 1px rgba(0,0,0,0.1),0 1px 2px 0 rgba(0,0,0,0.2);
}
.S_txt2{
	color: #808080;
...
<li class="simple-post-list">
	<div class="list-permalink">
		<div class="BXH-TOP">
			<div class="top-box top-ahbp">
				<div class="cate-top"><span >Top tháng 5</span></div>
				@if(!empty ($TopsAHBP))
				<div class="divider"></div>
				<ul>
					@foreach($TopsAHBP as $top)
					<li class="simple-hero">
						...
						<div class="WB_right_expand">
							...
							<div class="expand S_bg1">
								...
								<p class="S_txt3">{{ $top->created_time['time-ago'] }}</p>
							</div>
						</div>
					</li>
					@endforeach
